...
function AdminForm() {
  ...
  return (
    <div className="relative min-h-full w-full flex items-center justify-center bg-gray-50 rounded-md p-3 dark:bg-gray-800">
      <section className="w-full max-w-6xl p-4 md:p-6 flex flex-col gap-4 bg-white border border-gray-300 rounded-lg shadow dark:bg-gray-700 dark:border-gray-600 dark:text-white">
